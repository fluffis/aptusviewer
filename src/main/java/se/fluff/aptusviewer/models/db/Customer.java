...
public class Customer {
    ...
    private Date fastApiTimestamp;

    private AptusObjectInCustomer aptusObjectInCustomer;
    ...
    public Date getFastApiTimestamp() {
        return fastApiTimestamp;
    }

    public void setFastApiTimestamp(Date fastApiTimestamp) {
